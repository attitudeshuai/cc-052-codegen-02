...
func main() {
	...
	machineSvc := service.NewMachineService(machineRepo, bookingRepo, plotRepo, farmRepo)
	...
	// Router
	r := router.Setup(farmH, plotH, batchH, activityH, inspectionH, traceCodeH, machineH, healthH, rdb)
